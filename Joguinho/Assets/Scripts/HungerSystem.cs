    ...
    void SetupPostProcessing()
    {
        ...
        if (globalVolume != null)
        {
            ...
            if (!volumeProfile.TryGet(out chromaticAberration))
                Debug.LogWarning("Chromatic Aberration n�o encontrado!");
            else
                chromaticAberration.active = true; // Garante que est� ativo
        }
    }

    void Update()
    {
        // Sistema de diminui��o de fome
