...
{
    public static bool BloqueioInicialCelular = true; // <- 🔒 Evita uso do celular nos primeiros segundos
    ...
    IEnumerator IniciarSequencia()
    {
        ...
        // Libera o uso do celular após a sequência inicial
        BloqueioInicialCelular = false;
